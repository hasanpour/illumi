...
public class ColorArcProgressBar extends View{
    ...
    private void initConfig(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, ir.internat.illumi.R.styleable.ColorArcProgressBar);
        int color1 = a.getColor(ir.internat.illumi.R.styleable.ColorArcProgressBar_front_color1, Color.GREEN);
        int color2 = a.getColor(ir.internat.illumi.R.styleable.ColorArcProgressBar_front_color2, color1);
        int color3 = a.getColor(ir.internat.illumi.R.styleable.ColorArcProgressBar_front_color3, color1);
        colors = new int[]{color1, color2, color3, color3};

        sweepAngle = a.getInteger(ir.internat.illumi.R.styleable.ColorArcProgressBar_total_engle, 270);
        bgArcWidth = a.getDimension(ir.internat.illumi.R.styleable.ColorArcProgressBar_back_width, dipToPx(2));
        progressWidth = a.getDimension(ir.internat.illumi.R.styleable.ColorArcProgressBar_front_width, dipToPx(10));
        isNeedTitle = a.getBoolean(ir.internat.illumi.R.styleable.ColorArcProgressBar_is_need_title, false);
        isNeedContent = a.getBoolean(ir.internat.illumi.R.styleable.ColorArcProgressBar_is_need_content, false);
        isNeedUnit = a.getBoolean(ir.internat.illumi.R.styleable.ColorArcProgressBar_is_need_unit, false);
        isNeedDial = a.getBoolean(ir.internat.illumi.R.styleable.ColorArcProgressBar_is_need_dial, false);
        hintString = a.getString(ir.internat.illumi.R.styleable.ColorArcProgressBar_string_unit);
        titleString = a.getString(ir.internat.illumi.R.styleable.ColorArcProgressBar_string_title);
        curValues = a.getFloat(ir.internat.illumi.R.styleable.ColorArcProgressBar_current_value, 0);
        maxValues = a.getFloat(ir.internat.illumi.R.styleable.ColorArcProgressBar_max_value, 60);
            ...
            for (int i = 0; i < 40; i++) {
                ...
                if (i % 5 == 0) {
                    ...
                    canvas.drawLine(centerX,
                            ...
                            centerY - diameter /
                                    2 - progressWidth /
                                    2 - DEGREE_PROGRESS_DISTANCE - longDegree, degreePaint);
                } else {
                    ...
                    canvas.drawLine(centerX,
                            centerY - diameter /
                                    2 - progressWidth /
                                    2 - DEGREE_PROGRESS_DISTANCE - (longDegree - shortDegree) /
                                    2,
                            centerX,
                            centerY - diameter /
                                    2 - progressWidth /
    ...
    /**
     * Set the width of the entire arc
     * @param bgArcWidth
     */
    ...
    /**
     * Sets whether to display unit text
     * @param isNeedUnit
     */
    ...
    /**
     * Sets whether to display an external dial
     * @param isNeedDial
     */
